...
class NodeStatus(models.Model):
    node_id = models.CharField(max_length=255, unique=True, verbose_name="ID Ноды (Remnawave)")
    status_text = models.CharField(max_length=255, null=True, blank=True, verbose_name="Статус сервера")
    use_manual_status = models.BooleanField(default=False, verbose_name="Ручное управление")
    manual_is_online = models.BooleanField(default=True, verbose_name="Статус онлайн (вручную)")
